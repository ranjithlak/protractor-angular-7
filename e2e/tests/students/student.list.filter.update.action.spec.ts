...
describe('List User - Navigate to Edit Page', () => {
    ...
    it('navigate to user update Page', async () => {
        ...
        await listPage.clickUpdateStudent(1);

        // Test will fail, it always redirects to /update/0
        expect(await Helpers.getCurrentUrl()).toContain(browser.params.routes.update + '/' + chosenStudent)
    });
});
